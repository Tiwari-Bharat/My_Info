...
export const Bio = {
  ...
  github: "https://github.com/Tiwari-Bharat",
  resume: "#",
  linkedin: "#",
  twitter: "#",
...
export const personalInfo = [{
  ...
  details: [{
  ...
  },
    {
      ...
      value: "PM Shri Jawahar Navodaya Vidyalaya",
      icon: Award
    },
    {
      title: "Class / Section / Roll No.",
      value: "XI / Science / 1105",
      icon: BookOpen
    },
  ],
},
  {
    ...
    details: [{
      title: "Father’s Name",
      value: "Shree Devendra Prasad Tiwari",
      icon: User
    },
      {
        title: "Aadhaar Name",
        value: "Devendra Prasad Tiwari",
        icon: IdCard
      },
      {
        title: "Aadhaar Number",
        value: "8377-8901-9260",
        icon: IdCard
      },
      {
        title: "Phone Number",
  ...
  },
  {
    ...
    details: [{
      title: "Mother’s Name",
      value: "Smt. Anita Devendraprasad Tiwari",
      icon: Heart
    },
      {
        title: "Aadhaar Name",
        value: "Anita Tiwari / Anitadevi",
        icon: IdCard
      },
      {
        title: "Aadhaar Number",
        value: "4585-3294-6875",
        icon: IdCard
      },
      {
        title: "Phone Number",
  ...
  },
  {
    ...
    icon: Droplets,
    details: [{
      title: "Date of Birth / Blood Group",
      value: "19 Oct 2009 / O+",
      icon: Calendar
    },
      {
      ...
      {
        title: "Address",
        value: "Chanod, Vapi, Valsad, Gujarat.",
        icon: Home
      },
      {
        title: "Aadhaar Card",
        value: "4555-1319-4333",
        icon: IdCard
      },
    ],
  },
  {
    ...
    details: [{
      ...
      {
        title: "Special Skill",
        value: "Creative Coding & Web Designing",
        icon: PenTool
      },
      {
        title: "Hobbies",
        value: "Writing, Designing, Exploring AI Tools",
        icon: Brain
      },
      {
        title: "Ambition",
        value: "To become a Full Stack Developer",
        icon: Target
      },
    ],
  },
  ...
  },
  {
    ...
    details: [{
      ...
      {
        title: "Simplenote",
        value: "https://app.simplenote.com/"
      },
      {
        title: "Mediafire",
        value: "https://www.mediafire.com/"
      },
      {
        title: "SSYoutube",
        value: "https://ssyoutube.online/en2/"
      },
    ],
  },
  {
    ...
    details: [{
      title: "Mediafire",
      value: "tiwaribharat5321@gmail.com",
      icon: IdCard
    },
      {
        title: "Password",
        value: "9WPgd3E5EUc/L?z",
        icon: KeyRound
      },
      {
        title: "Simplenote",
...
export const education = [{
  ...
  grade: "None",
  desc: "I am currently pursuing my senior secondary education (Classes XI and XII) at Jawahar Navodaya Vidyalaya, Valsad. At this stage, my academic focus is directed toward subject specialization, analytical thinking, and preparation for higher education.",
  degree: "XI and XII",
},
  {
    id: 1,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPgUURd7SP-3oMj7WfaV0Dg7QkR7ySfXwEofM5gtjoTw&s=10",
    school: "Jawahar Navodaya Vidyalaya, Valsad",
    date: "Apr 2024 - Apr 2025",
    grade: "Not Available",
    desc: "I completed my secondary education (Class X) at Jawahar Navodaya Vidyalaya, Valsad. This phase strengthened my conceptual understanding and served as a crucial academic transition from foundational learning to advanced studies.",
    degree: "X Pass",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    grade: "Not Available",
    desc: "I completed my upper primary education (Classes II to V) at St. Joseph English Higher Secondary School, Karvad. This stage focused on building essential literacy, numeracy, and structured learning habits that supported my later academic growth.",
  ...
  },
  {
    ...
    date: "2016 - 2017",
    grade: "Not Available",
    desc: "I completed my pre-primary education (Junior KG and Senior KG) at Arthab Public School. Here, I developed early cognitive skills, social awareness, and learning readiness that formed the base of my academic journey.",
...
export const projects = [{
...
},
  {
    ...
    description:
      "Notable Cloud Storage By Bharat Dev",
    image:
      "#",
    tags: [
      "ReactJS",
    ...
    category: "web app",
    github: "#",
    webapp: "https://notablecs.netlify.app/",
  },
  {
    id: 3,
    title: "2048-Game",
    ...
    category: "web games",
    github: "#",
    webapp: "https://gem-2048.netlify.app/",
  },
  {
    id: 4,
    title: "Advance-TTS",
